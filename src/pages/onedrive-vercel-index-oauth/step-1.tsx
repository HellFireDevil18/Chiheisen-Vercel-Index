          ...
          <div className="rounded bg-white p-3 dark:bg-gray-900 dark:text-gray-100">
            ...
            <p className="py-1 text-sm font-medium text-yellow-400">
              <Trans>
                ...
                inside your Vercel env variable, go set up a PostgreSQL database at{' '}
                <a href="https://vercel.com/docs/storage/vercel-postgres" target="_blank" rel="noopener noreferrer" className="underline">
                  Vercel Postgres
                </a>
                {' '}or any PostgreSQL provider. Docs:{' '}
                <a
